...
package Number::Binary::Convert::binary32;
...
my $k    =   32;        # storage width (in bits)
my $p    =   24;        # precision (in bits)
my $t    =   23;        # number of bits in significand
my $w    =    8;        # number of bits in exponent
my $emax =  127;        # = 2 ** (w - 1) - 1;
my $emin = -126;        # = 1 - emax;
my $bias =  127;        # = emax
...
my $decoder = sub {
    ...
    my $sign =  $in >> 31;
    my $expo = ($in >> 23) & 0x000000ff;        # 8 bits
    my $mant =  $in        & 0x007fffff;        # 23 bits
