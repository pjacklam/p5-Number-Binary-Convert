...
package Number::Binary::Convert::binary64;
...
my $k    =    64;       # storage width (in bits)
my $p    =    53;       # precision (in bits)
my $t    =    52;       # number of bits in significand
my $w    =    11;       # number of bits in exponent
my $emax =  1023;       # = 2 ** (w - 1) - 1;
my $emin = -1022;       # = 1 - $emax;
my $bias =  1023;       # = emax
...
my $decoder = sub {
    ...
    my $sign =  $hi >> 31;                      # 1 bit
    my $expo = ($hi >> 20) & 0x000007ff;        # 11 bits
    my $mant =  $hi & 0x000fffff;               # 20 bits
