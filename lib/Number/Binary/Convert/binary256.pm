...
package Number::Binary::Convert::binary256;
...
my $k    =     256;     # storage width (in bits)
my $p    =     237;     # precision (in bits)
my $t    =     236;     # number of bits in significand
my $w    =      19;     # number of bits in exponent
my $emax =  262143;     # = 2 ** (w - 1) - 1;
my $emin = -262142;     # = 1 - $emax;
my $bias =  262143;     # = emax
...
my $decoder = sub {
    ...
    #
    #  |----- 19 ----||----- 12 -----|
    # seeeeeeeeeeeeeeemmmmmmmmmmmmmmmm     most significant 32 bits
    #
    # |------------- 32 -------------|
    # mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm     second most significant 32 bits
    #
    # ...

    my @in = unpack "N*", $in;
    my $sign =  $in[0] >> 31;                   # 1 bit
    my $expo = ($in[0] >> 12) & 0x0007ffff;     # 19 bits
    my $mant =  $in[0]        & 0x00000fff;     # 12 bits
    for (1 .. 7) {
